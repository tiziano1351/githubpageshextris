...
function showHelp() {
	...
	$("#inst_main_body").html("<div id='instructions_head'>COMO JUGAR</div><p>El objetivo de Hextris es evitar que los bloques salgan del interior del hexagono gris exterior.</p><p>" + 
(settings.platform != 'mobile' ? 'Presiona las teclas de flecha izquierda y derecha' : 'Toca los lados izquierdo y derecho de la pantalla') + 
" para girar el hexagono." + 
(settings.platform != 'mobile' ? ' Presiona la flecha hacia abajo para acelerar la caida del bloque' : '') + 
"</p><p>Elimina bloques y gana puntos haciendo que 3 o mas bloques del mismo color se toquen.</p><p>El tiempo restante antes de que desaparezca tu racha de combos esta indicado por <span style='color:#f1c40f;'>las</span> <span style='color:#e74c3c'>lineas</span> <span style='color:#3498db'>de colores</span> <span style='color:#2ecc71'>en</span> el hexagono exterior.</p><hr><p id='afterhr'></p><br><strong>Hecho por Tiziano Guevara, Bruno Garcia, Maximiliano Rodriguez y Gabriel Grosso.</strong>");
if (gameState == 1) {
		pause();
	}
